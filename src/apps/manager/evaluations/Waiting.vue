<template>
    <div class="form clearfix">
        <h3>Students</h3>
        <p>The following {{students ? students.length : 0}} students need to provide feedback</p>
    
        <div>
            <br/>
        </div>
    
        <el-table v-loading="students.length==0" :data="students" border style="width: 100%">
...
export default {
    ...
    computed: {
        ...
        students() {
            ...
            list = list.filter((s) => s.waiting_feedback === true)
