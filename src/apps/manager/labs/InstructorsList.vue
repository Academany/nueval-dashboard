<template>
  <div class="form clearfix">
    ...
    <el-form ref="myForm" :rules="rules" :model="form" label-position="left" label-width="150px">
      <el-autocomplete class="inline-input" v-model="form.input" :fetch-suggestions="querySearch" placeholder="Please Input" @select="handleSelect"></el-autocomplete>
    ...
    <el-table :data="instructors" style="width: 100%">
      <el-table-column prop="first_name" label="First" fit>
      </el-table-column>
      <el-table-column prop="last_name" label="Last" fit>
      </el-table-column>
      <el-table-column prop="username" label="Username" fit>
      </el-table-column>
      <el-table-column prop="email" label="Email" fit>
      </el-table-column>
