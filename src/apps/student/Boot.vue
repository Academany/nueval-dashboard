                ...
                <el-col :span="12" :offset="6">
                    <el-card>
                        ...
                        <el-select v-model="selectedRole">
                            <el-option v-for="role in filteredRoles" :label="role.student.course.name" :value="role" :key="role.role"></el-option>
                        </el-select>
                    </el-card>
                </el-col>
            </el-row>
...
export default {
    ...
    methods: {
        launchApp: function () {
            //   alert('boot')
            var vm = this;
            this.bootApp(this.selectedRole.student).then((success) => {
                vm.loading = false;
                vm.loaded = 100;
