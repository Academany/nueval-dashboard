                            ...
                            <table class="module-list-header">
                                <tr>
                                    ...
                                    <td v-if="globalEval.instructor">
                                        <strong>Instructor</strong> {{ globalEval.instructor.username}}</td>
                                </tr>
                            </table>
                            <SelectModule :data="modules" :records="globalEval.records" @select-module="handleSelectModule" />
                        </el-col>
                        <el-col :span="16">
                            <UnitPage v-if="module && record" :module="module" :record="record" :readonly="true" :global="true">
                            </UnitPage>
                        </el-col>
                    </el-row>
