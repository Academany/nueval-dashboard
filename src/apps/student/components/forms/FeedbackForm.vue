...
export default {
    ...
    computed: {
        ...mapGetters({
            'currentStudent': 'student_app/student',
            'currentEval': 'student_app/currentEval',
    ...
    methods: {
        handleSend() {
            ...
            formRef.validate(function (valid) {
                if (valid) {
                    vm.$emit('newFeedback', {
                        from: vm.currentStudent.username,
                        to: vm.currentEval && vm.currentEval.instructor ? vm.currentEval.instructor.username : vm.currentStudent.username,
